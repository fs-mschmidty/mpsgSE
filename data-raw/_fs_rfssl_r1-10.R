...
# data ----
rfss_file <- file.path("data-raw", "data", "fs", "2024_RFSS_Lists_R1-10.xlsx")
...
rfss_taxonomy <- rfss_raw |> 
  dplyr::select(taxon_id, scientific_name, kingdom:subspecies, form:variety)
